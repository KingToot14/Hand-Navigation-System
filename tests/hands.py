...
class Hand:
    ...
    def update_landmarks(self, landmarks: list[tuple[float, float]]) -> None:
        ...
        print(f"Fingertips:")
        print(f" - ({'T' if self.f1_bent else 'F'}) Thumb: {self.f1}")
        print(f" - ({'T' if self.f2_bent else 'F'}) Pointer: {self.f2}")
        print(f" - ({'T' if self.f3_bent else 'F'}) Middle: {self.f3}")
        print(f" - ({'T' if self.f4_bent else 'F'}) Ring: {self.f4}")
        print(f" - ({'T' if self.f5_bent else 'F'}) Pinky: {self.f5}")
